...
public class FragmentPost extends Fragment {
    ...
    Account account;
    String url="https://cookingbamboo.herokuapp.com/api/PostOfYou";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.rv_post);
        getData();
        //phuc hoi
        if (savedInstanceState != null) {
           data = (List<Dish>)savedInstanceState.get("listData");
            Toast.makeText(getContext(), "helooo ửod", Toast.LENGTH_SHORT).show();
        }
        return view;
    }
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        outState.putSerializable("listData",(Serializable)data);
